  ...
  return (
    <section id="projects" className="py-20 mb-16 text-center sm:text-left">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Hotel app */}
        {/* Hotel Expense Management App */}
        <div className="bg-gray-800 p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-4">Hotel Expense Management App</h3>
          <p className="text-gray-400 mb-4">
          Developed an app to simplify hotel expense tracking with features to manage expenses and export data to Excel.
          </p>
          <div className="flex space-x-4 mb-4">
            <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" alt="React Icon" width={30} height={30} />
            <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original.svg" alt="Node.js Icon" width={30} height={30} />
          ...
          <a href="https://hotel-frontend-mu.vercel.app/" target="_blank" className="text-purple-400 hover:text-purple-500">View Project</a>
        </div>
